...
<body>
    ...
    <div class="main-container">
            ...
            <div class="area <?php echo (empty($area_1)) ? 'vazio': '';?> " data-info='
                <?php if(!empty($area_1)) {
                    foreach($area_1 as $auto) { ?> 
                        <form method="POST" action="./Interface/html/telaVenda.php">
        ...
        <div class="info-box-container" id="infoBoxContainer">
            ...
            <form method="POST" action="./Interface/html/telaVenda.php" class="info-box" id="infoBox">
    ...
    <script src='./Interface/js/janela.js'></script>
</body>
</html>